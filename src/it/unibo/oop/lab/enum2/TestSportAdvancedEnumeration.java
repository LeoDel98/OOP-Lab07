...
public final class TestSportAdvancedEnumeration {
    ...
    public static void main(final String... args) {
         ...
         */
        final Sport2SocialNetworkUserImpl<User> dcassani = new Sport2SocialNetworkUserImpl<>("Davide", "Cassani", "dcassani", 53);
        final Sport2SocialNetworkUserImpl<User> falonso = new Sport2SocialNetworkUserImpl<>("Fernando", "Alonso", "falonso", 34);
        ...
        // TEST getIndividualSports()
        Set<Sport> individual2 = dcassani.getIndividualSports();
        System.out.println("[Cassani] [Individual] [F1]: " + individual2.contains(Sport.F1));
        System.out.println("[Cassani] [Individual] [not TENNIS]: " +!individual2.contains(Sport.TENNIS));
